...
*Запоминаете этот волнительны момент в своей жизни и ставите себе галочку о том, что данные нужно уметь **готовить** перед тем как скармливать их машине в рамках какого-либо алгоритма. Знание матана и глубина знаний в этом вопросе определяет - сколько фильтров и других фич вы сможете придумать для того, что бы подготовить данные. А это в свою очередь определяет точность ваших вычислений.* 
