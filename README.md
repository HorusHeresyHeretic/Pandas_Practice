...
*Внимательно смотрите на две картинки снизу, сопоставляете их в своей голове и задаётесь вопросом как отсутствие 1234 строк в среде 70000 величин так подвинуло коофициент корреляции условно одинаковых переменных, что даже косимечески далёкий от матана человек может заметить разницу.* 
